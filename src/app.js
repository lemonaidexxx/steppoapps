(function () {
  ...
  function home() {
    return (
      ...
      '</div><p class="helper" style="margin-top:20px">Explore first. Choose your course. Apply when you’re ready.</p></div><div class="hero-art" aria-label="STEP: Skills, Training, Empowerment, Progress"><div class="art-top"><span>LEARNING OPENS DOORS</span><span>2026 / 27</span></div><div class="art-word">STEP<span>.</span></div><div class="stairs" aria-hidden="true"><i></i><i></i><i></i><i></i></div><div class="art-bottom">SKILLS. TRAINING. EMPOWERMENT. PROGRESS.</div></div></section><div class="hero-foot"><small>A JOINT PROGRAM OF</small><p>Committee on Training and Skills Development <strong>(CTSD)</strong></p><p>Committee on Members’ Welfare and Development <strong>(CMWD)</strong></p></div><div class="wrap"><section class="section"><div class="section-head"><div><div class="eyebrow">YOUR NEXT STEP STARTS HERE</div><h2>Explore the possibilities.</h2></div><a href="#courses">View all offerings ↗</a></div><div class="grid">' +
